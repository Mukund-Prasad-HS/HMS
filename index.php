...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-hospital-o " aria-hidden="true"></i><u><b>&nbspFIRST HOSPITALS</b></u></h4></a>
...
<marquee> <u><i><b>Medicine-The First Priority</b></u></i></marquee>
<br>
<marquee><i>On account of 1st year anniversary,5% off on Doc Fees</i></marquee>
                <div class="row">
                    <div class="col-md-3 register-left" style="margin-top: 10%;right: 5%">
                        <img src="images/Namaskar.jpg" alt=""/>
                        <h3>Welcome</h3>
                            ...
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control" placeholder="Password(min 6 characters) *" id="password" name="password" onkeyup='check();' required/>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="index1.php">Already have an account? Click Here</a>
                                        </div>
                                    </div>
                ...
                <marquee><b><u><i>Enhanced and maintained by Mukund Prasad H S</u></b></i></marquee>
            </div>
